...
import com.sparta.timeattack.domain.Tag;
...
import com.sparta.timeattack.repository.TagRepository;
...
public class BoardService {
    ...
    public void createTag(TagRequestDto tagRequestDto) {
        Board board = boardRepository.findById(tagRequestDto.getIdx()).orElseThrow(
                () -> new NullPointerException("없다고오")
        );

        Tag tag = new Tag(tagRequestDto, board);
        tagRepository.save(board);
    }
